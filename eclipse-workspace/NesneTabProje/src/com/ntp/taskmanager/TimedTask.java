...
public class TimedTask extends Task {
    ...
    public void setStart(LocalDateTime start) { this.start = Objects.requireNonNull(start); }

    public LocalDateTime getEnd() { return end; }
    public void setEnd(LocalDateTime end) { this.end = Objects.requireNonNull(end); }
